export const MANAGERS = [
  ...
  },
  {
    ...
    name: "Alberto Zaccheroni",
    club: "Udinese / Milan / Lazio",
    years: "1997–2005",
    era: "classic",
    league: "serie_a",
    tier: "journeyman",
  ...
  },
  {
    ...
    flavourText: "Brought former player credibility to Nice. Built the side in his own image — physical, intense, with a clear footballing identity.",
    preferredArchetypes: ["Warrior","Grinder","Athlete"],
  },
  {
    id: "galtier-nice",
  ...
  // ── LEGENDS ──────────────────────────────────────────────────────────────
  // All-time great managers from eras predating the main database.
  {
    id: "clough-legend",
    name: "Brian Clough",
    nation: "🏴󠁧󠁢󠁥󠁮󠁧󠁿",
    ...
    tier: "elite",
    style: "direct",
    styleLabel: "Force of Personality",
    flavourText: "Walked into a Third Division club and won the European Cup. Twice. Impossible was just Old Big 'Ead's starting point.",
    preferredArchetypes: ["Leader","Maverick","Warrior"],
  },
  {
    id: "busby-legend",
    name: "Sir Matt Busby",
    ...
    tier: "elite",
    style: "attacking",
    styleLabel: "Expansive Attack",
    flavourText: "Rebuilt Manchester United from rubble after Munich — twice. Brought European football to Old Trafford and never stopped believing in beautiful, brave play.",
    preferredArchetypes: ["Athlete","Leader","Maverick"],
  },
  {
    id: "shankly-legend",
    name: "Bill Shankly",
    ...
    tier: "elite",
    style: "pressing",
    styleLabel: "Press & Passion",
    flavourText: "Took Liverpool from the Second Division and made them a fortress. Said football wasn't a matter of life and death — it was more important than that.",
    preferredArchetypes: ["Warrior","Grinder","Leader"],
  },
  {
    id: "paisley-legend",
    ...
    tier: "elite",
    style: "possession",
    styleLabel: "Quiet Ruthlessness",
    flavourText: "Three European Cups. Six league titles. Nine seasons. The most successful British manager in history — and the most reluctant to take the job in the first place.",
    preferredArchetypes: ["Technician","Leader","Athlete"],
  },
  {
    id: "revie-legend",
    name: "Don Revie",
    ...
    tier: "elite",
    style: "counter",
    styleLabel: "Organised Counter",
    flavourText: "Built the most feared team in England through meticulous preparation and iron organisation. Leeds under Revie didn't just want to win — they wanted to dominate.",
    preferredArchetypes: ["Grinder","Warrior","Leader"],
  },
  {
    id: "nicholson-legend",
    ...
    tier: "elite",
    style: "attacking",
    styleLabel: "The Double",
    flavourText: "Led Spurs to the first league and cup Double of the 20th century in 1961. Believed football existed to be enjoyed, and his team made sure of it.",
    preferredArchetypes: ["Athlete","Technician","Maverick"],
  },
  {
    id: "stein-legend",
    ...
    tier: "elite",
    style: "attacking",
    styleLabel: "Lisbon Lions",
    flavourText: "In 1967 his Celtic side — every player born within 30 miles of Celtic Park — became the first British club to win the European Cup. Pure football, no limits.",
    preferredArchetypes: ["Warrior","Athlete","Leader"],
  },
  {
    id: "chapman-legend",
    ...
    tier: "elite",
    style: "attacking",
    styleLabel: "Tactical Pioneer",
    flavourText: "Invented the WM formation, introduced numbered shirts, floodlights, and the offside trap. Won titles at Huddersfield and Arsenal. Redefined what a football manager was.",
    preferredArchetypes: ["Technician","Leader","Grinder"],
  },
  {
    id: "michels-legend",
    name: "Rinus Michels",
    ...
    tier: "elite",
    style: "pressing",
    styleLabel: "Total Football",
    flavourText: "The General. Every player could play every position. His Ajax won the European Cup and his Netherlands reached the World Cup final. Total Football began here.",
    preferredArchetypes: ["Athlete","Technician","Maverick"],
  },
  {
    id: "herrera-legend",
    ...
    tier: "elite",
    style: "counter",
    styleLabel: "Grande Inter",
    flavourText: "Il Mago — the Wizard. His Grande Inter of the 1960s won back-to-back European Cups with an iron defence and lethal counter-attack. Catenaccio perfected.",
    preferredArchetypes: ["Grinder","Warrior","Leader"],
  },
  {
    id: "sacchi-legend",
    ...
    tier: "elite",
    style: "pressing",
    styleLabel: "High Press Revolution",
    flavourText: "Never played professional football, yet built the greatest pressing team the game had seen. Milan's coordinated high line and zonal marking changed football forever. You don't need to have been a horse to be a jockey.",
    preferredArchetypes: ["Warrior","Technician","Athlete"],
  },
  {
    id: "pentland-legend",
    name: "Fred Pentland",
    ...
    tier: "elite",
    style: "attacking",
    styleLabel: "Basque Pioneer",
    flavourText: "The Englishman who introduced professional football to Spain in the 1920s. Won La Liga twice with Athletic Bilbao and sparked a revolution that still echoes through Spanish football today.",
    preferredArchetypes: ["Athlete","Technician","Grinder"],
  },
];
